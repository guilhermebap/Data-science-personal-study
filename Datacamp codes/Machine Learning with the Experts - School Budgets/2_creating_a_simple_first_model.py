...
def combine_text_columns(data_frame, to_drop=NUMERIC_COLUMNS + LABELS):
    ...
    text_data.fillna('', axis=0, inplace=True)
...
You'll compare the effect of tokenizing using any non-whitespace characters
as a token and using only alphanumeric characters as a token.
'''
