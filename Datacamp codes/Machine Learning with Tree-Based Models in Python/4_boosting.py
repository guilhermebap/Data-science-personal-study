...
Once the classifier ada is trained, call the .predict_proba() method by passing
X_test as a parameter and extract these probabilities by slicing all the values
...
Recall that the ROC AUC score of a binary classifier can be determined using the
